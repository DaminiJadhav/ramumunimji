package com.posbilling.posbillingapplication.activity.settingcontainer;
...
import com.posbilling.posbillingapplication.activity.dashboard.ui.setting.SettingContractor;
import com.posbilling.posbillingapplication.activity.dashboard.ui.setting.SettingPresenter;
...
public class ActivitySettingContainer extends BaseActivity implements SettingContractor.View, OnStateListClick {
...
/*            View rootView = activity.getWindow().getDecorView().getRootView();
    ...
    private void setOnEnglish(TextView textView_english, TextView textview_marathi) {
        textView_english.setTextColor(getResources().getColor(R.color.colorGreen));
        textview_marathi.setTextColor(getResources().getColor(R.color.black));
    ...
    private void setOnMarathi(TextView textView_english, TextView textview_marathi) {
        textview_marathi.setTextColor(getResources().getColor(R.color.colorGreen));
        textView_english.setTextColor(getResources().getColor(R.color.black));
...
//                    cameraIntent();
    ...
    public void profileUpdateResponse(ClientUpdateResponse body) {
        ...
        //commented on 10/8/2020
   /*     Utility.getInstance().localisation(ActivitySettingContainer.this, languageCodeMarathi);
        Utility.getInstance().setLanguage(ActivitySettingContainer.this, languageCodeMarathi);*/

        startActivity(new Intent(ActivitySettingContainer.this, HomeActivityTwo.class));
        finishAffinity();
