...
public class OTPSuccessResponse {
    ...
    LoginResponse.ContentDetail ContentDetail;
    ...
    public class ContentDetail {
        ...
        ArrayList<LoginResponse.ContentDetail.BusinessDetails> businessDetailsArrayList = new ArrayList<LoginResponse.ContentDetail.BusinessDetails>();
        ...
        ArrayList<LoginResponse.ContentDetail.tblClientProfiles> tblClientProfiles = new ArrayList<LoginResponse.ContentDetail.tblClientProfiles>();
        ...
        ArrayList<LoginResponse.ContentDetail.tblClientStatus> tblClientStatusArrayList = new ArrayList<LoginResponse.ContentDetail.tblClientStatus>();
        ...
        ArrayList<LoginResponse.ContentDetail.tblCustomers> tblCustomersArrayList = new ArrayList<LoginResponse.ContentDetail.tblCustomers>();
        ...
        public class tblCustomers {
            ...
            ArrayList<LoginResponse.ContentDetail.tblCustomers.tblInvices> tblInvicesArrayList = new ArrayList<LoginResponse.ContentDetail.tblCustomers.tblInvices>();
            ...
            public ArrayList<LoginResponse.ContentDetail.tblCustomers.tblInvices> getTblInvicesArrayList() {
                return tblInvicesArrayList;
            }

            public void setTblInvicesArrayList(ArrayList<LoginResponse.ContentDetail.tblCustomers.tblInvices> tblInvicesArrayList) {
                this.tblInvicesArrayList = tblInvicesArrayList;
            }
        }

        @SerializedName("tblExpenditures")
        ArrayList<LoginResponse.ContentDetail.tblExpenditures> tblExpendituresArrayList = new ArrayList<LoginResponse.ContentDetail.tblExpenditures>();
        ...
        ArrayList<LoginResponse.ContentDetail.tblPresitcidesAndFertilisers> tblPresitcidesAndFertilisersArrayList = new ArrayList<LoginResponse.ContentDetail.tblPresitcidesAndFertilisers>();
        ...
        ArrayList<LoginResponse.ContentDetail.tblVehicleDetails> tblVehicleDetailsArrayList = new ArrayList<LoginResponse.ContentDetail.tblVehicleDetails>();
        ...
        public ArrayList<LoginResponse.ContentDetail.BusinessDetails> getBusinessDetailsArrayList() {
            return businessDetailsArrayList;
        }

        public void setBusinessDetailsArrayList(ArrayList<LoginResponse.ContentDetail.BusinessDetails> businessDetailsArrayList) {
        ...
        public ArrayList<LoginResponse.ContentDetail.tblClientStatus> getTblClientStatusArrayList() {
            return tblClientStatusArrayList;
        }

        public void setTblClientStatusArrayList(ArrayList<LoginResponse.ContentDetail.tblClientStatus> tblClientStatusArrayList) {
            this.tblClientStatusArrayList = tblClientStatusArrayList;
        }

        public ArrayList<LoginResponse.ContentDetail.tblCustomers> getTblCustomersArrayList() {
            return tblCustomersArrayList;
        }

        public void setTblCustomersArrayList(ArrayList<LoginResponse.ContentDetail.tblCustomers> tblCustomersArrayList) {
            this.tblCustomersArrayList = tblCustomersArrayList;
        }

        public ArrayList<LoginResponse.ContentDetail.tblExpenditures> getTblExpendituresArrayList() {
            return tblExpendituresArrayList;
        }

        public void setTblExpendituresArrayList(ArrayList<LoginResponse.ContentDetail.tblExpenditures> tblExpendituresArrayList) {
            this.tblExpendituresArrayList = tblExpendituresArrayList;
        }

        public ArrayList<LoginResponse.ContentDetail.tblPresitcidesAndFertilisers> getTblPresitcidesAndFertilisersArrayList() {
            return tblPresitcidesAndFertilisersArrayList;
        }

        public void setTblPresitcidesAndFertilisersArrayList(ArrayList<LoginResponse.ContentDetail.tblPresitcidesAndFertilisers> tblPresitcidesAndFertilisersArrayList) {
            this.tblPresitcidesAndFertilisersArrayList = tblPresitcidesAndFertilisersArrayList;
        }

        public ArrayList<LoginResponse.ContentDetail.tblVehicleDetails> getTblVehicleDetailsArrayList() {
            return tblVehicleDetailsArrayList;
        }

        public void setTblVehicleDetailsArrayList(ArrayList<LoginResponse.ContentDetail.tblVehicleDetails> tblVehicleDetailsArrayList) {
